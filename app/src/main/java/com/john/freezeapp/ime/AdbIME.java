package com.john.freezeapp.ime;
...
public class AdbIME extends InputMethodService {
	private String IME_MESSAGE = "FREEZE_APP_ADB_INPUT_TEXT";
	private String IME_CHARS = "FREEZE_APP_ADB_INPUT_CHARS";
	private String IME_KEYCODE = "FREEZE_APP_ADB_INPUT_CODE";
	private String IME_META_KEYCODE = "FREEZE_APP_ADB_INPUT_MCODE";
	private String IME_EDITORCODE = "FREEZE_APP_ADB_EDITOR_CODE";
	private String IME_MESSAGE_B64 = "FREEZE_APP_ADB_INPUT_B64";
	private String IME_CLEAR_TEXT = "FREEZE_APP_ADB_CLEAR_TEXT";
	private BroadcastReceiver mReceiver = null;

	@Override
	public View onCreateInputView() {
		View mInputView = getLayoutInflater().inflate(R.layout.ime, null);
